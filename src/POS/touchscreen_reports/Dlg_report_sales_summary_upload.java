 ...
 * @author Ronescape
 */
public class Dlg_report_sales_summary_upload extends javax.swing.JDialog {

    /** Creates new form Dlg_report_sales_summary_upload */
...
private Dlg_report_sales_summary_upload(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_sales_summary_upload(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);    
        initComponents();
        myInit();
    ...
    public Dlg_report_sales_summary_upload() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_sales_summary_upload myRef;

    private void setThisRef(Dlg_report_sales_summary_upload myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_sales_summary_upload> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_sales_summary_upload create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_sales_summary_upload create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_sales_summary_upload dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_sales_summary_upload((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_sales_summary_upload((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_sales_summary_upload dialog = Dlg_report_sales_summary_upload.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Accounts Receivable:");
        ...
        jLabel8.setText("Last Remittance:");
