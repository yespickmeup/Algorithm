 ...
 * @author Guinness
 */
public class Dlg_report_template2 extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_report_template2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_template2(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_template2 myRef;

    private void setThisRef(Dlg_report_template2 myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_template2> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_template2 create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_template2 create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_template2 dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_template2((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_template2((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_template2 dialog = Dlg_report_template2.create(new javax.swing.JFrame(), true);
