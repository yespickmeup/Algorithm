 ...
 * @author Guinness
 */
public class Dlg_report_cashcount extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_report_cashcount(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_cashcount(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_cashcount myRef;

    private void setThisRef(Dlg_report_cashcount myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_cashcount> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_cashcount create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_cashcount create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_cashcount dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_cashcount((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_cashcount((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_cashcount dialog = Dlg_report_cashcount.create(new javax.swing.JFrame(), true);
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String where = " where Date(time_in) between '" + date_from + "' and '" + date_to + "' "
                        + " and session_no='" + f.getId() + "' "
                        + " and location_id='" + lo.getId() + "' ";
                if (jCheckBox1.isSelected()) {
                    where = " where Date(time_in) between '" + date_from + "' and '" + date_to + "'  "
                            + " and location_id='" + lo.getId() + "'";
                }
                System.out.println(where);
                List<Srpt_cashcount.field> fields = Srpt_cashcount.cashcount(where);
