 ...
 * @author Guinness
 */
public class Dlg_report_ar_payments extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_report_ar_payments(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_ar_payments(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_ar_payments myRef;

    private void setThisRef(Dlg_report_ar_payments myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_ar_payments> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_ar_payments create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_ar_payments create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_ar_payments dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_ar_payments((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_ar_payments((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_ar_payments dialog = Dlg_report_ar_payments.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    private void init_report() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                List<Srpt_ar_payments.field> fields = Srpt_ar_payments.ret_data(where);
    ...
    private void report_sales_items(final Srpt_ar_payments to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_expenses(Srpt_ar_payments to, String rpt_name) {
        try {
