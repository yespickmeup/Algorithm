 ...
 * @author Guinness
 */
public class Dlg_graphs extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_graphs
     */
...
//</editor-fold>
    ...
    private Dlg_graphs(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_graphs(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_graphs myRef;

    private void setThisRef(Dlg_graphs myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_graphs> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_graphs create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_graphs create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_graphs dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_graphs((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_graphs((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_graphs dialog = Dlg_graphs.create(new javax.swing.JFrame(), true);
