 ...
 * @author Guinness
 */
public class Dlg_ar_items extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_ar_items
     */
...
//</editor-fold>
    ...
    private Dlg_ar_items(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_ar_items(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_ar_items myRef;

    private void setThisRef(Dlg_ar_items myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_ar_items> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_ar_items create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_ar_items create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_ar_items dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_ar_items((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_ar_items((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_ar_items dialog = Dlg_ar_items.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
        ...
        nd.setCallback(new Dlg_ar_search.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_ar_search.OutputData data) {
                ...
                if (!reference.equalsIgnoreCase(ar.reference_no)) {
                    reference = reference + ar.reference_no;
                }
    ...
    private void data_cols() {
        ...
        if (datas.isEmpty()) {
            String where2 = " where charge_reference_no like '%" + jTextField11.getText() + "%' and charge_customer_id= '" + customer.getId() + "'  "
                    + " and charge_amount='" + FitIn.toDouble(jTextField6.getText()) + "' limit 1";
            ...
            String where3 = " where sales_no='" + or_no + "' order by id asc ";
            List<Charge_in_advance_items.to_charge_in_advance_items> datas2 = Charge_in_advance_items.ret_data_sale_items(where3);
            loadData_charge_in_advance_items(datas2);
        }
