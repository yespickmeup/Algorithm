...
public class zInventory {
    ...
    public static void update_item(Inventory.to_inventory to_inventory, String unit, double conversion, double selling_price, int update_all_branches, String where) {
        try {
