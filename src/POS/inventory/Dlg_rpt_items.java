...
//                btn_0.doClick();
    ...
    private void loadData_items(List<S1_items2.to_items> acc) {
        tbl_items_ALM.clear();
    ...
    public static class TblitemsModel extends AbstractTableAdapter {
        ...
        public Object getValueAt(int row, int col) {
            S1_items2.to_items tt = (S1_items2.to_items) getRow(row);
            switch (col) {
                case 0:
    ...
    private void data_cols() {
        ...
        String sub_class = cb_sub_class.getSelectedItem().
                toString();
        loadData_items(S1_items2.ret_data2(category, classification, sub_class));
        
        List<S1_items2.to_items> datas=tbl_items_ALM;
        double total=0;
        for(S1_items2.to_items to:datas){
