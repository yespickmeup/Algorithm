 ...
 * @author Guinness
 */
public class Dlg_inventory_price_updates_finalized extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_inventory_price_updates_finalized(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_inventory_price_updates_finalized(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_inventory_price_updates_finalized() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_inventory_price_updates_finalized myRef;

    private void setThisRef(Dlg_inventory_price_updates_finalized myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_inventory_price_updates_finalized> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_inventory_price_updates_finalized create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_inventory_price_updates_finalized create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_inventory_price_updates_finalized dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_inventory_price_updates_finalized((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_inventory_price_updates_finalized((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_inventory_price_updates_finalized dialog = Dlg_inventory_price_updates_finalized.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Finalized Transactions");
