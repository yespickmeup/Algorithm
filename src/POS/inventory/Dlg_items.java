...
import POS.inventory.S1_item_multi_level_pricing.to_item_multi_level_pricing;
...
//        dialog.setVisible(true);
    ...
    private void initComponents() {
        ...
        tf_markup = new javax.swing.JTextField();
        ...
        jLabel21.setText("MARK UP:");

        tf_markup.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tf_markup.setHorizontalAlignment(javax.swing.JTextField.CENTER);
                ...
                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jXPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jXPanel2Layout.createSequentialGroup()
                                .addGap(2, 2, 2)
                                .addComponent(tf_cost, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel10)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tf_selling_price, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE))
                            .addComponent(cb_supplier, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(cb_sub_class, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jXPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jXPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jXPanel2Layout.createSequentialGroup()
                                        .addComponent(tf_barcode, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(tf_markup, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        jXPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jXPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel21, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(tf_markup))
                    .addComponent(tf_product_qty, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
//        items();
    ...
    private void tf_costKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_costKeyReleased
        // TODO add your handling code here:set_price();
        set_price();
...
//                        e.consume();
    ...
    public static class TblitemsModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "QTY", "ITEM CODE", "DESCRIPTION", "generic_name", "CATEGORY", "category_id", "CLASSIFICATION", "classification_id", "SUPPLIER"
                , "sub_classification_id", "SUPPLIER", "COST", "SUPPLIER", "SELL. PRICE", "date_added", "user_name", "VAT", "ACTIVE", "MULTI", "FIX PRICE"
        };
    ...
    private void data_cols() {
        ...
        loadData_items(S1_items2.ret_data(search, category, classification, sub_class, supplier));
    }
    ...
    private void add_items() {
        ...
        String barcodes="";
        to_items to = new to_items(id, barcode, description, generic_name, category, category_id
                , classification, classification_id,
                sub_classification, sub_classification_id, product_qty, unit, conversion, selling_price, date_added
                , user_name, item_type, status, supplier, fixed_price, cost, supplier_id
                , multi_level_pricing, new ArrayList(), vatable,reorder_level,markup,barcodes);


        S1_items2.add_items(to);
        if (cb_multi_pricing.isSelected()) {
...
//                convertRowIndexToModel(row));
        ...
        double markup=FitIn.toDouble(tf_markup.getText());
         String barcodes="";
        to_items to1 = new to_items(id, barcode, description, generic_name, category, category_id, classification, classification_id
                , sub_classification, sub_classification_id, product_qty, unit, conversion, selling_price, date_added, user_name
                , item_type, status, supplier, fixed_price, cost, supplier_id, multi_level_pricing
                , new ArrayList(), vatable,reorder_level,markup,barcodes);
        S1_items2.edit_items(to1, code);
        data_cols();
        clear_items();
        btn_edit.setEnabled(true);
        btn_delete.setEnabled(true);
...
//        tf_conversion.setText("");
    ...
    private void delete_items() {
        String barcode = tf_barcode.getText();
        S1_items2.delete_items(barcode);
        data_cols();
        clear_items();
        btn_edit.setEnabled(false);
        btn_delete.setEnabled(false);
...
//        tf_barcode.setText("");
    ...
    private void set_price(){
        ...
        double addtl=(markup/100)*cost;
        tf_selling_price.setText(FitIn.fmt_wc_0(cost+addtl));
    }
}
