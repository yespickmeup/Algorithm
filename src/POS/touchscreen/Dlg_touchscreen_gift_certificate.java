 ...
 * @author Guinness
 */
public class Dlg_touchscreen_gift_certificate extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_touchscreen_gift_certificate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_gift_certificate(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_touchscreen_gift_certificate() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_gift_certificate myRef;

    private void setThisRef(Dlg_touchscreen_gift_certificate myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_touchscreen_gift_certificate> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_touchscreen_gift_certificate create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_touchscreen_gift_certificate create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_touchscreen_gift_certificate dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_touchscreen_gift_certificate((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_touchscreen_gift_certificate((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_touchscreen_gift_certificate dialog = Dlg_touchscreen_gift_certificate.create(new javax.swing.JFrame(), true);
    ...
    public void do_pass() {
        Payments.gift_certificate gc = Payments.gift_certificate;
        if (gc.amount == 0) {
            tf_amount.setText(FitIn.fmt_wc_0(Payments.countChange()));
        } else {
            tf_from.setText(gc.from);
            tf_description.setText(gc.from);
            tf_gc_no.setText(gc.from);
            tf_amount.setText(FitIn.fmt_wc_0(gc.amount));
        }
    }
...
//                btn_0.doClick();
    ...
    private void ok() {
        ...
        Payments.gift_certificate gc = new Payments.gift_certificate(from, description, gc_no, amount);
        Payments.gift_certificate = gc;
        if (callback != null) {
