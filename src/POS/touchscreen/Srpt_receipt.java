...
public class Srpt_receipt {
    ...
    public Srpt_receipt(String business_name, String operated_by, String address, String tin_no, String serial_no, String permit_no, String datetime, String or_no, String items, double total_due, double cash, double change_due, String receipt_infos, String receipt_footer, double discount, String customer_name, String cashier_name, String discount_name, String pos_no, int total_qty, double vatable_sale, double zero_rate_sale, double vat_exempt_sale, double vat_percent, String acct_no, String trans_no, String check_bank, double check_amount, String telephone_number, String discount_customer_name, String discount_customer_id, String min_no, double addtl_service, String customer_address, String reference_no, double amount_due, String check_no, double line_discount, double credit_card, double gift_certificate, double prepaid, double charge_amount) {
    ...
    public static class field {
        ...
        public field(String desc, Date date_added, double total, double qty, double selling_price, double discount) {
            this.desc = desc;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 20; i++) {
            Srpt_receipt.field tbar = new Srpt_receipt.field("desc" + i, new Date(), 9, 20.5 + i, 2 + i, 0);
            fields.add(tbar);
        }
