 ...
 *
 * This file, JXCollapsiblePane1.java is part of JTStand.
 *
...
/**
 * <code>JXCollapsiblePane1</code> provides a component which can collapse or
 ...
 * <p>
 * The {@code JXCollapsiblePane1} has a "content pane" that actually holds the
 ...
 *
 * <p>
 * In this example, the <code>JXCollapsiblePane1</code> is used to build a
 * Search pane which can be shown and hidden on demand.
 *
 * <pre>
 * <code>
 * JXCollapsiblePane1 cp = new JXCollapsiblePane1();
 *
 * // JXCollapsiblePane1 can be used like any other container
 ...
 * JButton toggle = new JButton(cp.getActionMap().get(JXCollapsiblePane1.TOGGLE_ACTION));
 ...
 *
 * <p>
 * The <code>JXCollapsiblePane1</code> has a default toggle action registered
 ...
 *   get(JXCollapsiblePane1.TOGGLE_ACTION);
 *
 * // use the collapse/expand icons from the JTree UI
 * toggleAction.putValue(JXCollapsiblePane1.COLLAPSE_ICON,
 *                       UIManager.getIcon("Tree.expandedIcon"));
 * toggleAction.putValue(JXCollapsiblePane1.EXPAND_ICON,
 *                       UIManager.getIcon("Tree.collapsedIcon"));
 * </code>
 * </pre>
 *
 * <p>
 * Note: <code>JXCollapsiblePane1</code> requires its parent container to have a
 ...
 *
 * @javabean.class name="JXCollapsiblePane1" shortDescription="A pane which
 * hides its content with an animation." stopClass="java.awt.Component"
 *
 * @author rbair (from the JDNC project)
 * @author <a href="mailto:fred@L2FProd.com">Frederic Lavigne</a>
 * @author Karl George Schaefer
 */
public class JXCollapsiblePane1 extends JXPanel {
     ...
     * <code>collapsiblePane.getActionMap().get(JXCollapsiblePane1.TOGGLE_ACTION)</code>.
     */
    public final static String TOGGLE_ACTION = "toggle";

    /**
     * The icon used by the "toggle" action when the JXCollapsiblePane1 is
    ...
    /**
     * Constructs a new JXCollapsiblePane1 with a {@link JXPanel} as content
     * pane and a vertical {@link VerticalLayout} with a gap of 2 pixels as
     * layout manager and a vertical orientation.
     */
    public JXCollapsiblePane1() {
        this(Direction.UP, new BorderLayout(0, 0));
    }

    /**
     * Constructs a new JXCollapsiblePane1 with a {@link JXPanel} as content
     * pane and the specified direction.
     *
     * @param direction the direction to collapse the container
     */
    public JXCollapsiblePane1(Direction direction) {
        this(direction, new BorderLayout(0, 0));
    }

    /**
     * Constructs a new JXCollapsiblePane1 with a {@link JPanel} as content pane
     * and the given LayoutManager and a vertical orientation
     */
    public JXCollapsiblePane1(LayoutManager layout) {
     ...
     *
     * @param direction the direction this pane collapses
     * @param layout of this collapsible pane
     */
    public JXCollapsiblePane1(Direction direction, LayoutManager layout) {
    ...
    /**
     * Toggles the JXCollapsiblePane1 state and updates its icon based on the
     * JXCollapsiblePane1 "collapsed" status.
     */
    private class ToggleAction extends AbstractAction implements
        ...
        public ToggleAction() {
            ...
            // icon
            JXCollapsiblePane1.this.addPropertyChangeListener("collapsed", this);
        }
    ...
    /**
     * Sets the content pane of this JXCollapsiblePane1. The
     * {@code contentPanel}
     ...
     *
     * @param contentPanel the container delegate used to hold all of the
     * contents for this collapsible pane
     ...
     *
     * <p>
     * When animated, the <code>JXCollapsiblePane1</code> will progressively
     ...
     *
     * <p>
     * If not animated, the <code>JXCollapsiblePane1</code> will simply hide
    ...
    /**
     * Expands or collapses this <code>JXCollapsiblePane1</code>.
     *
     * <p>
     * If the component is collapsed and <code>val</code> is false, then this
     * call expands the JXCollapsiblePane1, such that the entire
     * JXCollapsiblePane1 will be visible. If {@link #isAnimated()} returns
     * true, the expansion will be accompanied by an animation.
     *
     * <p>
     * However, if the component is expanded and <code>val</code> is true, then
     * this call collapses the JXCollapsiblePane1, such that the entire
     * JXCollapsiblePane1 will be invisible. If {@link #isAnimated()} returns
     ...
     * <code>JXCollapsiblePane1</code> relies on the calculation of its
     * preferred size. During the animation, its preferred size (specially its
     * height) will change, when expanding, from 0 to the preferred size of the
     * content pane, and the reverse when collapsing.
     *
    ...
    /**
     * Tagging interface for containers in a JXCollapsiblePane1 hierarchy who
     ...
     * JXCollapsiblePane1 is enough but there might be cases where the parent
    ...
    private static class AnimationParams {
        ...
        /**
         * @param waitTime the amount of time in milliseconds to wait between
         * calls to the animation thread
    ...
    private final class AnimationListener implements ActionListener {
        ...
        /**
         * Mutex used to ensure that the startDimension/finalDimension are not
         * changed during a repaint operation.
         */
        private final Object ANIMATION_MUTEX = "Animation Synchronization Mutex";
        /**
         * This is the starting dimension when animating. If > finalDimension,
         * then the animation is going to be to scroll up the component. If it
         * is less than finalDimension, then the animation will scroll down the
         * component.
         */
        private int startDimension = 0;
        /**
         * This is the final dimension that the content container is going to be
            ...
            synchronized (ANIMATION_MUTEX) {
                if (startDimension == finalDimension) {
                    ...
                    if (finalDimension > 0) {
                        ...
                        validate();
                        JXCollapsiblePane1.this.firePropertyChange(ANIMATION_STATE_KEY, null,
                                                                   "expanded");
                        return;
                    } else {
        ...
        void validate() {
            Container parent = SwingUtilities.getAncestorOfClass(
                    CollapsiblePaneContainer.class, JXCollapsiblePane1.this);
            if (parent != null) {
...
//                f.add(tree1);
//
//                JXCollapsiblePane1 pane = new JXCollapsiblePane1(Orientation.VERTICAL);
...
//                        JXCollapsiblePane1.TOGGLE_ACTION);
//                    
//                pane = new JXCollapsiblePane1(Orientation.HORIZONTAL);
