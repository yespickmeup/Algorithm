...
public class Excel_to_db_inventory_items {
    ...
    public Excel_to_db_inventory_items(String qty, String item_code, String barcode, String description, String cost, String selling_price, String category, String classification, String sub_classification, String brand, String model, String unit, String wholesale, String reorder_level) {
        this.qty = qty;
...
//        List<String> query = Inventory.add_inventory_list(tos);
    ...
    public static void main(String[] args) {
        ...
        String file = "C:\\Users\\Ronescape\\Documents\\Excel Files\\Laarns\\encode.xls";
...
//                System.out.println("unit:" + unit);
                Excel_to_db_inventory_items encoded = new Excel_to_db_inventory_items(qty, item_code, barcode, description, cost, selling_price, category, classification, sub_classification, brand, model, unit, wholesale, reorder_level);
                if (record[0] != null) {
                    datas.add(encoded);
                    System.out.println("");
                }
