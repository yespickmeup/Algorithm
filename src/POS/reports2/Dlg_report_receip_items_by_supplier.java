 ...
 * @author Ronald
 */
public class Dlg_report_receip_items_by_supplier extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_report_receip_items_by_supplier
     */
...
//</editor-fold>
    ...
    private Dlg_report_receip_items_by_supplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_receip_items_by_supplier(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_report_receip_items_by_supplier() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_receip_items_by_supplier myRef;

    private void setThisRef(Dlg_report_receip_items_by_supplier myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_receip_items_by_supplier> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_receip_items_by_supplier create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_receip_items_by_supplier create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_receip_items_by_supplier dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_receip_items_by_supplier((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_receip_items_by_supplier((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_receip_items_by_supplier dialog = Dlg_report_receip_items_by_supplier.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(dp_from, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(dp_to, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void myInit() {
        init_key();
        tf_supplier.enable(false);
        focus();
    }

    private void focus() {
        JTextField[] tf = {tf_supplier};
...
//                btn_0.doClick();
    ...
    private void get_data() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String where = "";
                if (jCheckBox1.isSelected()) {
                    where = " where date(date_added) between '" + date_from + "' and '" + date_to + "' order by supllier_id,description asc";
                } else {
                    where = " where date(date_added) between '" + date_from + "' and '" + date_to + "' ";
                    where = where + " and supllier_id='" + tf_supplier_id.getText() + "' order by supllier_id,description asc ";
                }
                List<Srpt_receipts_items_by_supplier.field> datas = Srpt_receipts_items_by_supplier.ret_data(where);
    ...
    private void report_sales_items(final Srpt_receipts_items_by_supplier to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_all_sales(Srpt_receipts_items_by_supplier to, String rpt_name) {
