...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Other Settings", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel4.setText("Main Branch:");
    ...
    private void myInit() {
        ...
        JTextField[] tfs = {jTextField1, jTextField2, jTextField3, jPasswordField2, jTextField5, jTextField4};
...
//                btn_0.doClick();
    ...
    private void ret_data() {
        ...
        jTextField4.setText(setting.version);
        jTextField1.setText(setting.cloud_host);
        jTextField2.setText(setting.cloud_port);
        jTextField3.setText(setting.cloud_user);
        jPasswordField2.setText(setting.cloud_password);
        jTextField5.setText(setting.cloud_db);
    ...
    private void update_data() {
        ...
        String cloud_host = jTextField1.getText();
        String cloud_port = jTextField2.getText();
        String cloud_user = jTextField3.getText();
        String cloud_password = jPasswordField2.getText();
        String cloud_db = jTextField5.getText();
        ...
        Settings.update_data_cloud(id, version, cloud_host, cloud_port, cloud_user, cloud_password, cloud_db,is_main_branch);
        Alert.set(2, "");
    ...
    private void authenticate() {
        ...
        JCheckBox[] boxes = {jCheckBox14, jCheckBox15, jCheckBox16, jCheckBox17, jCheckBox18, jCheckBox8, jCheckBox9, jCheckBox10, jCheckBox11, jCheckBox13, jCheckBox12, jCheckBox1};
