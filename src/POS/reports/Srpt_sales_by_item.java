...
public class Srpt_sales_by_item {
    ...
    public Srpt_sales_by_item(String business_name, String business_owner, String business_address, String date_printed, String sales_date, String printed_by) {
    ...
    public static void main(String[] args) {
        ...
        Srpt_sales_by_item rpt = new Srpt_sales_by_item(business_name, business_owner, business_address, date_printed, sales_date, printed_by);
    ...
    public static List<Srpt_sales_by_item.field> ret_data(String date_from, String date_to, String category1) {
        ...
        try {
            ...
            String s0 = "select "
                    ...
                    + " and category like'%" + category1 + "%' group by barcode,selling_price order by category asc "
                    + " ";
