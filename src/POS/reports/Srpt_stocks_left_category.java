...
public class Srpt_stocks_left_category {
    ...
    public Srpt_stocks_left_category(String business_name, String business_owner, String business_address, String date_printed, String sales_date, String printed_by) {
    ...
    public static void main(String[] args) {
        ...
        Srpt_stocks_left_category rpt = new Srpt_stocks_left_category(business_name, business_owner, business_address, date_printed, sales_date, printed_by);
