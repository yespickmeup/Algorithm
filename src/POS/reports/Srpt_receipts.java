...
public class Srpt_receipts {
    ...
    public Srpt_receipts(String business_name, String business_owner, String business_address, String date_printed, String sales_date, String printed_by) {
    ...
    public static class field {
        ...
        public field(String date_added, String barcode
                , String description, double product_qty
                , double selling_price, String category, String unit
                , double total,double previous_cost) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            Srpt_receipts.field to = new field(date_added, barcode
                    , description, product_qty, selling_price
                    , category, unit, total,0);
            fields.add(to);
        }
        ...
        Srpt_receipts rpt = new Srpt_receipts(business_name, business_owner, business_address, date_printed, sales_date, printed_by);
    ...
    public static List<Srpt_receipts.field> ret_data(String date_from, String date_to) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                double previous_cost = rs.getDouble(21);
                ...
                Srpt_receipts.field to = new Srpt_receipts.field(date_added, barcode
                        , description, product_qty, selling_price, category, unit
                        , total,previous_cost);
                datas.add(to);
            }
            return datas;
...
//                    + " group by barcode,unit "
                    + " order by date(date_delivered) asc";
            ...
            while (rs.next()) {
                ...
                double total = product_qty * selling_price;
                Srpt_receipts.field to = new Srpt_receipts.field(date_added, barcode, description, product_qty, selling_price, category
                        , unit, total,previous_cost);
                datas.add(to);
            }
            return datas;
        } catch (Exception e) {
     ...
     public static List<Srpt_receipts.field> ret_data_by_supplier_(String date_from, String date_to, String supplier1) {
        List<Srpt_receipts.field> datas = new ArrayList();
        try {
            Connection conn = MyConnection.connect();
            String s0 = "select "
            ...
            while (rs.next()) {
                ...
                double total = product_qty * selling_price;
                Srpt_receipts.field to = new Srpt_receipts.field(date_added, barcode, description, product_qty, selling_price, category, unit
                        , total,previous_cost);
                datas.add(to);
            }
            return datas;
