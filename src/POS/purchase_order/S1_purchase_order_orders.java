...
public class S1_purchase_order_orders {
    ...
    public static class to_purchase_order_orders {
        ...
        public to_purchase_order_orders(int id, String po_no, String user_name, String session_no, String date_added, String supplier
                ...
                , double conversion, String unit, double total,String brand,String brand_id,String model,String model_id,String main_barcode) {
            this.id = id;
            this.po_no = po_no;
