...
public class Dlg_return_from_customer_qty extends javax.swing.JDialog {
    ...
    public static class OutputData {
        ...
        public OutputData(double qty, String remarks) {
            this.qty = qty;
...
//</editor-fold>
    ...
    public void do_pass(String item_code, String description, double ordered, double total_returned, String reason, double qty) {
...
//                btn_0.doClick();
    ...
    private void ok() {
        ...
        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(qty, reason));
        }
    }
}
