 ...
 * @author i1
 */
public class Dlg_group extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_group(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_group(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_group myRef;

    private void setThisRef(Dlg_group myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_group> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_group create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_group create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_group dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_group((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_group((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().
                        log(Level.INFO, "instances: {0}", dialogContainer.size());
    ...
    public static void main(String args[]) {
        ...
        Dlg_group dialog = Dlg_group.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CATEGORY", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
