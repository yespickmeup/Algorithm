...
//            total += t1.remaining_balance;
        ...
        if (i == 1) {
            ...
            nd.setCallback(new Dlg_ap_payment.Callback() {
                @Override
                public void ok(CloseDialog closeDialog, Dlg_ap_payment.OutputData data) {
                    closeDialog.ok();
                    ...
                    for (to_accounts_payable ap : selected_ap) {
...
//                        }
    ...
    private void single_payment(final to_accounts_payable to) {
...
//        nd.do_pass(to.remaining_balance);
    ...
    private void loadData_accounts_receivable(List<to_accounts_payable> acc) {
