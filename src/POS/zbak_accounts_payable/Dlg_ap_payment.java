 ...
 * @author i1
 */
public class Dlg_ap_payment extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_ap_payment
     */
...
//</editor-fold>
    ...
    private Dlg_ap_payment(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_ap_payment(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_ap_payment myRef;

    private void setThisRef(Dlg_ap_payment myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_ap_payment> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_ap_payment create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_ap_payment create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_ap_payment dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_ap_payment((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_ap_payment((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().
                        log(Level.INFO, "instances: {0}", dialogContainer.size());
    ...
    public static void main(String args[]) {
        ...
        Dlg_ap_payment dialog = Dlg_ap_payment.create(new javax.swing.JFrame(), true);
