...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/businessman37.png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/barcode12.png"))); // NOI18N
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/list.png"))); // NOI18N
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/worker55.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/team2.png"))); // NOI18N
        ...
        jLabel22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/four94.png"))); // NOI18N
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/factories1.png"))); // NOI18N
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/sort-by-order (1).png"))); // NOI18N
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/work11.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/logistics2.png"))); // NOI18N
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/copy23.png"))); // NOI18N
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons_menu_reports/work11.png"))); // NOI18N
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        ok("Print Barcodes", jLabel9);
    }//GEN-LAST:event_jLabel9MouseClicked

    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ok("Item Ledger", jLabel10);
    ...
    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        ok("Cashier Report", jLabel12);
    }//GEN-LAST:event_jLabel12MouseClicked

    private void jLabel16MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel16MouseClicked
        ok("Inventory Count Sheet", jLabel16);
    ...
    private void jLabel9MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseEntered
        label("Print Barcode", jLabel9);
    }//GEN-LAST:event_jLabel9MouseEntered

    private void jLabel10MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseEntered
        label("Item Ledger", jLabel10);
    ...
    private void jLabel12MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseEntered
        label("Cashier Report", jLabel12);
    }//GEN-LAST:event_jLabel12MouseEntered

    private void jLabel16MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel16MouseEntered
        label("Inventory Count Sheet", jLabel16);
    ...
    private void jLabel22MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel22MouseClicked
        ok("Inventory Count", jLabel22);
    }//GEN-LAST:event_jLabel22MouseClicked

    private void jLabel22MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel22MouseEntered
        label("Inventory Count", jLabel22);
    }//GEN-LAST:event_jLabel22MouseEntered

    private void jLabel17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel17MouseClicked
        ok("AR Items", jLabel17);
    }//GEN-LAST:event_jLabel17MouseClicked

    private void jLabel17MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel17MouseEntered
        label("AR Items", jLabel17);
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        ok("Stock Take (No Cost)", jLabel13);
    }//GEN-LAST:event_jLabel13MouseClicked

    private void jLabel13MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseEntered
        label("Stock Take (No Cost)", jLabel13);
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        ok("Disbursements Report", jLabel14);
    }//GEN-LAST:event_jLabel14MouseClicked

    private void jLabel14MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseEntered
        label("Disbursements Report", jLabel14);
...
//        MyUser.setUser_id("" + 1);
    ...
    private void hover() {
        ...
        JLabel[] lbl = {jLabel7, jLabel8, jLabel9, jLabel10, jLabel11, jLabel12, jLabel16, jLabel17, jLabel18, jLabel13, jLabel21, jLabel14};
    ...
    private void hide2() {
        JLabel[] lbl = {jLabel7, jLabel8, jLabel9, jLabel10, jLabel11, jLabel22, jLabel12, jLabel16, jLabel17, jLabel18, jLabel13, jLabel19, jLabel21};
        for (JLabel l : lbl) {
            l.setEnabled(false);
        }
    }
    ...
    private void set_previledge() {
        ...
        for (S1_user_previleges.to_user_previleges to : datas) {
            ...
            if (to.previledge.equalsIgnoreCase("Disbursements Report")) {
                jLabel14.setEnabled(true);
                jLabel14.setBackground(new java.awt.Color(96, 188, 219));
            }
            if (to.previledge.equalsIgnoreCase("Re-Order Level - (View)")) {
                jLabel19.setEnabled(true);
                jLabel19.setBackground(new java.awt.Color(96, 188, 219));
            }
            if (to.previledge.equalsIgnoreCase("Cash Count Report")) {

            }
            if (to.previledge.equalsIgnoreCase("Suppliers - Report")) {
            ...
            if (to.previledge.equalsIgnoreCase("Daily Sales Summary Report")) {
            ...
            if (to.previledge.equalsIgnoreCase("Purchase Order Report")) {

            }

            if (to.previledge.equalsIgnoreCase("Receipts Report")) {
            ...
            if (to.previledge.equalsIgnoreCase("Stock Transfer Report")) {
            ...
            if (to.previledge.equalsIgnoreCase("Sales Report")) {

            }

            if (to.previledge.equalsIgnoreCase("Inventory Count - (View)")) {
            ...
            if (to.previledge.equalsIgnoreCase("Barcodes - (View)")) {
                jLabel9.setEnabled(true);
                jLabel9.setBackground(new java.awt.Color(96, 188, 219));
            }

            if (to.previledge.equalsIgnoreCase("Print Inventory Count")) {
                jLabel16.setEnabled(true);
                jLabel16.setBackground(new java.awt.Color(96, 188, 219));
            }

            if (to.previledge.equalsIgnoreCase("AR Items - (View)")) {
                if (module_accounts_receivable.equals("1")) {
            ...
            if (to.previledge.equalsIgnoreCase("BIR - (View)")) {
