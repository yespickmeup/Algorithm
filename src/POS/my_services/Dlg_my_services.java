...
import POS.my_services.S1_my_services_others.to_my_services_others;
...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img/stock_transfer.png"))); // NOI18N
        ...
        btn_edit1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img/b_edit.png"))); // NOI18N
        ...
        btn_edit2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img/b_edit.png"))); // NOI18N
        ...
        btn_edit3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/img/b_edit.png"))); // NOI18N
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jScrollPane8, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 411, Short.MAX_VALUE)
    ...
    private void myInit() {
        ...
        jTextField6.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
...
//        tbl_my_services.getColumnModel().getColumn(8).setCellRenderer(new CustomRenderer());
        ...
        for (S1_my_services_description.to_my_services_description t5 : desc) {
            My_services_description_customers.to_my_services_description_customers t2
                    = new My_services_description_customers.to_my_services_description_customers(
                            0, t5.description, t5.amount, customer_id, customer_name, transaction_no, DateType.datetime.format(new Date()), Users.user_name, t5.unit, t5.barcode, my_branch, my_branch_id, my_location, my_location_id);
    ...
    private void add_all_problems(String transaction_no) {
        List<S1_my_services_problems_customers.to_my_services_problems_customers> datas = new ArrayList();
        ...
        for (S1_my_services_problems.to_my_services_problems to : probs) {
            ...
            double am = to.amount;
            S1_my_services_problems_customers.to_my_services_problems_customers to1 = new S1_my_services_problems_customers.to_my_services_problems_customers(id, problem, customer_id, customer_name, transaction_no, date_added, am, my_branch, my_branch_id, my_location, my_location_id);
            datas.add(to1);
        }
        S1_my_services_problems_customers.add_my_services_problems_customers(datas);
    }

    private void add_all_replacements(String transaction_no) {
        List<S1_my_services_item_replacements_customers.to_my_services_item_replacements_customers> datas = new ArrayList();
...
//            add_customer();
    ...
    private void add_prob() {
        ...
        if (jButton5.isEnabled()) {
            ...
            String transaction_no = tf_transaction_no.getText();
            String date_added = DateType.datetime.format(new Date());
            S1_my_services_problems_customers.to_my_services_problems_customers to = new S1_my_services_problems_customers.to_my_services_problems_customers(id, problem, customer_id, customer_name, transaction_no, date_added, am, my_branch, my_branch_id, my_location, my_location_id);

            S1_my_services_problems_customers.add_my_services_problems_customers(to);
            data_probs();
            jTextField4.setText("");
            jTextField5.setText("");
        }
    ...
    private void edit_prob() {
        ...
        if (jButton5.isEnabled()) {
            ...
            String transaction_no = tf_transaction_no.getText();
            String date_added = DateType.datetime.format(new Date());
            S1_my_services_problems_customers.to_my_services_problems_customers to2 = new S1_my_services_problems_customers.to_my_services_problems_customers(id, problem, customer_id, customer_name, transaction_no, date_added, am, my_branch, my_branch_id, my_location, my_location_id);
            S1_my_services_problems_customers.edit_my_services_problems_customers(to2);
            data_probs();
            jTextField4.setText("");
            jTextField5.setText("");
            btn_edit2.setVisible(false);
