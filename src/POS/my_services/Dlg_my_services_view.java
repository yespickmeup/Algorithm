...
//        jLabel41.setText(FitIn.fmt_woc(total));
    ...
    private void select() {
        ...
        List<S1_my_services_problems.to_my_services_problems> problems = S1_my_services_problems_customers.ret_data(where2);
        String p = "";
        ...
        List<S1_my_services_item_replacements.to_my_services_item_replacements> replacements = S1_my_services_item_replacements_customers.ret_data2(S1_my_services_item_replacements_customers.ret_data(where3));
        String r = "";
