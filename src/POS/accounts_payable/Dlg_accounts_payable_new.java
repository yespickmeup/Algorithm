...
public class Dlg_accounts_payable_new extends javax.swing.JDialog {
    ...
    public static class OutputData {
        ...
        public OutputData(String date, double amount, String term, double discount_amount, String reference_no, String remarks) {
            this.date = date;
            this.amount = amount;
            this.term = term;
...
//</editor-fold>
    ...
    public void do_pass(String supplier,double balance,double credit_limit,String date,double amount,String term,double discount,String reference,String remarks) {
       ...
       jTextField3.setText(FitIn.fmt_wc_0(credit_limit));
        ...
        try {
            ...
            Logger.getLogger(Dlg_accounts_payable_new.class.getName()).log(Level.SEVERE, null, ex);
        }
        jTextField4.setText(FitIn.fmt_wc_0(amount));
        jTextField5.setText(term);
        jTextField6.setText(FitIn.fmt_wc_0(discount));
        jTextField7.setText(reference);
