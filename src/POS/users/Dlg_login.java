...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jPanel2.add(tf_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 12, 190, 30));
        ...
        jLabel3.setText("Login with your credentials");
    ...
    private void myInit() {
        init_key();
        MyBorder.setBorder2(tf_username);
...
//        if (callback != null) {
        if (to == null) {
            ...
            Users.setT_salesman(to.t_salesman);
...
//                    Users.setTime_out(to1.time_in);
                    if (to1.time_out == null) {
                        Users.setIs_active(0);
//                        Users.drawer.setTime_in(to1.time_in);
                    } else {
                        Users.setIs_active(1);
//                        Users.drawer.setTime_in(to1.time_in);
//                        Users.drawer.setTime_out(to1.time_out);
                    }
