...
//        select_item();
    ...
    public void do_pass(List<Stock_transfers.to_stock_transfers> stock_transfers, List<Inventory.to_inventory> items, int tab) {
...
//                btn_0.doClick();
    ...
    private void init_tbl_stock_transfers() {
        ...
        int[] tbl_widths_stock_transfers = {70, 100, 150, 150, 0, 100, 0, 0, 0, 0, 0, 0, 0};
