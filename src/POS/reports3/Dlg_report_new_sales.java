 ...
 * @author Guinness
 */
public class Dlg_report_new_sales extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_report_new_sales
     */
...
//</editor-fold>
    ...
    private Dlg_report_new_sales(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_new_sales(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_new_sales myRef;

    private void setThisRef(Dlg_report_new_sales myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_new_sales> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_new_sales create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_new_sales create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_new_sales dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_new_sales((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_new_sales((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_new_sales dialog = Dlg_report_new_sales.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Sales Ledger", jPanel2);
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jProgressBar2, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jTabbedPane1.addTab("Sales by Item", jPanel3);
    ...
    private void focus() {
        JTextField[] tf = {jTextField1, jTextField2};
...
//                btn_0.doClick();
    ...
    private void get_stocks() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String date_from2 = DateType.sf.format(jDateChooser1.getDate());
                String date_to = DateType.slash.format(jDateChooser2.getDate());
                String date_to2 = DateType.sf.format(jDateChooser2.getDate());
                String sales_date = "Sales Ledger Report as of [" + date_from + "] - [" + date_to + "]";
                Srpt_sales_ledger rpt = new Srpt_sales_ledger(sales_date);
                String where = " where Date(date_added) between '" + date_from2 + "' and '" + date_to2 + "' ";
                if (jCheckBox1.isSelected()) {
                    where = where + " and discount_customer_name like '%" + jTextField2.getText() + "%' ";
                } else {
                    where = where + " and sales_no like '%" + jTextField2.getText() + "%' ";
                }

                if (!jCheckBox5.isSelected()) {
                    if (jCheckBox4.isSelected()) {
                        where = where + " and sales_type ='" + "0" + "' ";
                    } else {
                        where = where + " and sales_type  ='" + "1" + "' ";
                    }
                }
                if (!jTextField3.getText().isEmpty()) {
                    where = where + " and user_name  like '" + jTextField3.getText() + "' ";
                }
                List<Srpt_sales_ledger.field> fields = Srpt_sales_ledger.ret_data(where);
                rpt.fields.addAll(fields);
                final String jrxml = "rpt_sales_ledger.jrxml";
    ...
    private void get_items() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                where=where+ " group by main_barcode,barcode,conversion,discount_amount order by description asc";
                List<Srpt_sales_by_item.field> fields = Srpt_sales_by_item.ret_data(where);
                rpt.fields.addAll(fields);
                final String jrxml = "rpt_sales_item.jrxml";
    ...
    private void report_sales_items2(final Srpt_sales_by_item to, String jrxml_name) {
        jPanel5.removeAll();
    ...
    public static JRViewer get_viewer_expenses2(Srpt_sales_by_item to, String rpt_name) {
        try {
            return JasperUtil.getJasperViewer(
    ...
    private void init_customers() {
        ...
        users_list.clear();
        String where = " ";
        users_list = S2_users.ret_where2(where);
        Object[][] obj = new Object[users_list.size()][1];
        int i = 0;
        ...
        JLabel[] labels = {};
        int[] tbl_widths_customers = {150};
        int width = 0;
        String[] col_names = {""};
        TableRenderer tr = new TableRenderer();
        TableRenderer.
                setPopup(jTextField1, obj, labels, tbl_widths_customers, col_names);
        tr.setCallback(new TableRenderer.Callback() {
            @Override
            public void ok(TableRenderer.OutputData data) {
                S1_users.to_users to = users_list.get(data.selected_row);
                jTextField1.setText(to.screen_name);
                jTextField3.setText(to.user_name);
